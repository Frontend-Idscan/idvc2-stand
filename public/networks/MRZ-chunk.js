...
/* eslint-disable no-underscore-dangle */ var MrzModule = /*#__PURE__*/ function() {
   ...
   */ function detectMrz(imageData) {
                var _this = this;
                return MrzModule_async_to_generator(function() {
                    var mrzResults, res1, prop, isNotMRZ, locations, results, res, res2, prop1;
                    return MrzModule_ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                return [
                            ...
                            case 1:
                                ...
                                console.log('c.mrzInfo', context/* default.mrzInfo */.Z.mrzInfo);
                                context/* default.mrzInfo.detectMRZ.push */.Z.mrzInfo.detectMRZ.push(JSON.parse(JSON.stringify(res1)));
                                isNotMRZ = true;
                                ...
                                res2 = {};
                                // eslint-disable-next-line guard-for-in,no-restricted-syntax
                                for(var prop1 in res){
                                    res2[prop1] = res[prop1];
                                }
                                context/* default.mrzInfo.detectRes.push */.Z.mrzInfo.detectRes.push(JSON.parse(JSON.stringify(res2)));
                                return [
                                    2,
                                    res
                                ];
